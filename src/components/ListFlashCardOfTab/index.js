...
export default function ListFlashCardOfTab(props) {
  ...
  const handleDelete = async (id) => {
    const confirmed = await confirmDelete(
      "Bạn có chắc chắn muốn xóa list từ này?"
    );
    if (confirmed) {
                ...
                {activeTab === 1 && (
                  <div className="listFlashcard-card__icons">
                    <EditOutlined
                      ...
                      className="listFlashcard-card__icon listFlashcard-card__icon--edit"
                    />
                    <DeleteOutlined
                      onClick={async (e) => {
                        e.stopPropagation();
                      ...
                      className="listFlashcard-card__icon listFlashcard-card__icon--delete"
                    />
                  </div>
                )}
              </div>
