...
export default function AddAndEditVocabForm(props) {
    const { Option } = Select;
    const { form, onOK, confirmLoading, initialValues, onFetchingData } = props;
        ...
        if (initialValues && initialValues.id) {
            ...
            if (values.image && values.image.length > 0) {
                ...
                if (fileNew && fileNew.originFileObj) {
                    ...
                    await putFormData(`api/card/update/image/${initialValues.id}`, formData);
                }
            }
            // Nếu chỉ là url, KHÔNG cần gọi api update image
            ...
            >
                ...
                >
                    <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                        ...
                        {previewUrl && (
                            <img src={previewUrl} alt="preview" style={{ width: 200, marginTop: 8 }} />
                        )}
                    </div>
                </Form.Item>
