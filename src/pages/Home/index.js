      ...
      try {
        ...
        if (data && Array.isArray(data)) {
          if (localStorage.getItem("accountName")) {
            const filterNotMyTopic = data;
            setTopicFlashCardList(filterNotMyTopic.slice(0, 5));
          } else setTopicFlashCardList(data.slice(0, 5));
        }
      } catch (error) {
    ...
    <>
      ...
      <div className="MainContainer">
        ...
        <div className="Container-listFlashcards">
          <h2 className="Container-listFlashcards__Title">
            Các topic phổ biến
          </h2>
        ...
        <div className="Container-listComments">
          <h2 className="Container-listComments__Title">
            Người dùng nói gì về VocaLearn
          </h2>
